...
from src.backend.application.funnel.dtos.create_funnel import CreateFunnelCommand, CreateFunnelResult
from src.backend.application.shared.interfaces.uow import UnitOfWork
from src.backend.domain.funnel.entity import Funnel
from src.backend.domain.funnel.policies.can_create_funnel import CanCreateFunnelPolicy
